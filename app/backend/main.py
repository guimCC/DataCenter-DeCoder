...
async def solve_placements(specs, module_list, fixed_modules_with_position: list[Module] = []):
    modules = get_modules()
    return solve_modules_placement_with_fixed(modules, specs, module_list, fixed_modules_with_position)
